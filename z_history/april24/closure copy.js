...
function setTableToStarted(table) {
	...
	table.step = 0; //ja wird gemacht!!!
	//console.log('setTableToStarted',table.players)
...
async function showDashboard() {
	...
	if (me == 'guest') mDom('dMain', { align: 'center', className: 'section' }, { html: 'click username in upper right corner to log in' })
}
...
function uiTypePlayerStats(table, me, dParent, layout, styles = {}) {
	...
	//addKeys({ rounding: 10, bg: '#00000050', margin: 4, box: true }, styles);
	let show_first = me;
